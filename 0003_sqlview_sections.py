...
--- Soil points section: 34 base datasets generated automatically---
...
CREATE OR REPLACE VIEW points_geo AS
  SELECT 
    id as pointid, type_id as point_type, date, location, lat_wgs84, lon_wgs84, 
...
CREATE OR REPLACE VIEW point_general_geo AS
  SELECT 
    t.*, t.type_id as point_type, a.n_layer, a.horizon_designation,
...
CREATE OR REPLACE VIEW labdata_layer AS
    SELECT 
      ...
      l.bulk_dens, l.met_bulk_dens_id, l.slake_test, l.met_slake_test, l.el_cond, l.met_el_cond_id,
      ...
      l.org_car, l.met_org_car_id, l.org_mat, l.met_org_mat_id, l.caco3_content, l.met_caco3_content_id,
...
CREATE OR REPLACE VIEW labdata_no_layer AS
    SELECT
      l.id, l.point_id, t.type_id as point_type, t.project, t.date, t.survey_m_id, 
      NULL::numeric(4,0) as l_number, NULL as horizon, l.upper::numeric(4,0), l.lower::numeric(4,0),
      l.gravel, l.cls_sys_id, l.texture_id, l.sand, l.v_c_sand, l.c_sand, l.m_sand, l.f_sand,
      l.v_f_sand, l.met_sand_id, l.silt, l.c_silt, l.f_silt, l.met_silt_id, l.clay, l.met_clay_id,
      l.bulk_dens, l.met_bulk_dens_id, l.slake_test, l.met_slake_test, l.el_cond, l.met_el_cond_id,
      l.hy_cond, l.met_hy_cond_id, l.satur, l.field_cap, l.wilting_p, l.awc, l.met_s_f_w_id, l.acidity,
      ...
      l.active_caco3, l.met_active_caco3_id, l.gypsum, l.met_gypsum_id, l.cec, l.met_cec_id, l.ca, l.mg, l.na,
      l.k, l.met_exc_id, base_saturation, esp, l.sol_ca, l.sol_mg, l.sol_na, l.met_sol_cations_id, l.sar, 
      l.n_tot, l.met_n_tot_id, l.p_cont, l.met_p_cont_id, l.nh4, l.met_nh4_id, l.no3, l.met_no3_id, l.roc, 
      l.toc400, l.met_roc_toc400_id, l.feox, l.fed, l.fep, l.fe_tot, l.met_fe_tot_id, l.mn, l.met_mn_id, 
      l.zn, l.met_zn_id, l.cu, l.met_cu_id, l.pb, l.met_pb_id, l.hg, l.met_hg_id, l.cd, l.met_cd_id, l.ni, 
      l.met_ni_id, l.sb, l.met_sb_id, l.cr, l.met_cr_id, l.as_value, l.met_as_id, l.co, l.met_co_id, l.v, 
      l.met_v_id, l.notes,
      st_setsrid(st_makepoint(t.lon_wgs84::double precision, t.lat_wgs84::double precision), 4326) AS geom
...
CREATE OR REPLACE VIEW layer_coarse_fragments_geo AS
    SELECT 
      t.id as point_id, t.point_type, t.project, t.date, t.survey_m_id, 
      l.upper, l.lower, l.id as layer_id, lr.*, t.geom
...
CREATE OR REPLACE VIEW photo_geo AS
    SELECT 
      p.id, p.title, p.caption, p.type_id, p.point_id, 
...
SQL_DROP = f"""
  DROP VIEW IF EXISTS addendum_point_general CASCADE;
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('backoffice', '0002_pointdata_and_more'),
    ]
