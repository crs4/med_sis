            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        ...
                        db_comment="Report the techniques that refer to the surrounding area of the soil monitoring site. If more than one type of technique is present, report in the array up to three, the dominant one first. Value from p_productivity_techniques",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.TextField(
                        db_comment="monitoring site identifier",
                        primary_key=True,
                        serialize=False,
                    ),
                ),
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        db_comment="Name of the monitoring location",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.TextField(
                        ...
                        db_comment="Classification system",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        db_comment="Ground surface upslope inclination with respect to the horizontal plane. If the monitoring site lies on a flat surface, the gradient is 0%. ",
                        decimal_places=10,
                        max_digits=30,
                        null=True,
                        validators=[backoffice.models.validate_percentage],
                ...
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        db_comment="Ground surface downslope inclination with respect to the horizontal plane. If the monitoring site lies on a flat surface, the gradient is 0%. ",
                        decimal_places=10,
                        max_digits=30,
                        null=True,
                        validators=[backoffice.models.validate_percentage],
                ...
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        db_comment="If the monitoring site lies on a slope, report the compass direction that the slope faces, viewed downslope; e.g., 225°",
                        decimal_places=10,
                        max_digits=30,
                        null=True,
                        validators=[backoffice.models.validate_positive],
                ...
                (
                    ...
                    models.TextField(
                        ...
                        db_comment="If the monitoring site lies on a slope, report the slope shape in 2 directions: up-/downslope (perpendicular to the elevation contour, i.e. the vertical curvature) and across slope (along the elevation contour, i.e. the horizontal curvature); e.g., Linear (L), Convex (V) or Concave (C).",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.TextField(
                        ...
                        db_comment="If the monitoring site lies in an uneven terrain, report the monitoring site position.",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        db_comment="Old classification of the profile ",
                        null=True,
                    ),
                ),
                (
                    ...
                    models.TextField(
                        blank=True,
                        db_comment="New classification of the profile ",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    "old_code",
                    models.TextField(
                        blank=True, db_comment="profile original code", null=True
                    ),
                ),
                (
                    "climateandweather",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "old_code",
                    models.TextField(
                        blank=True, db_comment="Original project id", null=True
                    ),
                ),
                (
                    "title",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "number",
                    models.SmallIntegerField(
                        db_comment="layer order in monitoring site",
                        validators=[backoffice.models.validate_positive],
                    ),
                ),
                (
                ...
                (
                    "site",
                    models.ForeignKey(
                        db_comment="Foreign Key field: site",
                        on_delete=django.db.models.deletion.CASCADE,
