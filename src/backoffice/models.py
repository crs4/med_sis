...
UPLOAD_TYPES = [
    ...
    ("XLS_PJ" , "Project Metadata XLSx upload"),
    ("XLS_PH" , "Photo Metadata XLSx upload"),
    ("XLS_EM", "Laboratory Extra Measure Data XLSx upload"),                    
]
UPLOAD_OPERATION = [
...
class LandformTopography(models.Model):
    ...
    grad_ups = models.FloatField( validators=[validate_percentage], blank=True, null=True, db_comment='Ground surface upslope inclination with respect to the horizontal plane. If the profile lies on a flat surface, the gradient is 0%. ')
    grad_downs = models.FloatField( validators=[validate_percentage], blank=True, null=True, db_comment='Ground surface downslope inclination with respect to the horizontal plane. If the profile lies on a flat surface, the gradient is 0%. ')
    slope_asp = models.FloatField( validators=[validate_positive], blank=True, null=True, db_comment='If the profile lies on a slope, report the compass direction that the slope faces, viewed downslope; e.g., 225°')
...
class LandUse(models.Model):
    ...
    nc_gs_avg_height = models.FloatField( blank=True, null=True)
    nc_gs_max_height = models.FloatField( blank=True, null=True)
    nc_gs_area = models.FloatField( blank=True, null=True)
    ...
    nc_us_avg_height = models.FloatField( blank=True, null=True)
    nc_us_max_height = models.FloatField( blank=True, null=True)
    nc_us_area = models.FloatField( blank=True, null=True)
    ...
    nc_ms_avg_height = models.FloatField( blank=True, null=True)
    nc_ms_max_height = models.FloatField( blank=True, null=True)
    nc_ms_area = models.FloatField( blank=True, null=True)
    ...
    cult_area = models.FloatField( validators=[validate_percentage], blank=True, null=True)
...
class Surface(models.Model):
    id = models.TextField(primary_key=True, db_comment='identifier')
    crust_area = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    ...
    outc_area = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    outc_dist = models.FloatField( blank=True, null=True)
    outc_size = models.FloatField( blank=True, null=True)
    ground_wat = models.FloatField( validators=[validate_positive], blank=True, null=True)
    ...
    desert_ven = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    desert_var = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    ...
    cs_total_area = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    ...
    cs_class1area = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    cs_class2area = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    cs_class3area = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    litter_avg_thick = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    litter_area = models.FloatField( validators=[validate_positive], blank=True, null=True)
    litter_max_thick = models.FloatField( validators=[validate_positive], blank=True, null=True)
...
class SurfaceUnevenness(models.Model):
    ...
    hum_ter_h = models.FloatField( validators=[validate_positive], blank=True, null=True)
    hum_noter_h = models.FloatField( validators=[validate_positive], blank=True, null=True)
    hum_noter_w = models.FloatField( validators=[validate_positive], blank=True, null=True)
    hum_noter_d = models.FloatField( validators=[validate_positive], blank=True, null=True)
    ero_area = models.FloatField( validators=[validate_percentage], blank=True, null=True)
...
class LabData(models.Model):
    ...
    l_number = models.FloatField( validators=[validate_positive],  db_comment='Layer Number' , blank=True, null=True)
    gravel = models.FloatField( validators=[validate_percentage],  db_comment='Gravel content (%)' , blank=True, null=True)
    ...
    sand = models.FloatField( validators=[validate_percentage], db_comment='Sand  (percentage of the fine earth)', blank=True, null=True)
    v_c_sand = models.FloatField( validators=[validate_percentage],db_comment='Very coarse sand (percentage of the fine earth)', blank=True, null=True)
    c_sand = models.FloatField( validators=[validate_percentage],db_comment='Coarse sand (percentage of the fine earth)', blank=True, null=True)
    m_sand = models.FloatField( validators=[validate_percentage],db_comment='Medium sand (percentage of the fine earth)', blank=True, null=True)
    f_sand = models.FloatField( validators=[validate_percentage],db_comment='Fine sand (percentage of the fine earth)', blank=True, null=True)
    v_f_sand  = models.FloatField( validators=[validate_percentage], db_comment='Very Fine sand (percentage of the fine earth)', blank=True, null=True)
    ...
    silt = models.FloatField( validators=[validate_percentage], db_comment='Silt (percentage of the fine earth)', blank=True, null=True)
    c_silt = models.FloatField( validators=[validate_percentage], db_comment='Coarse silt (percentage of the fine earth)', blank=True, null=True)
    ...
    field_cap = models.FloatField( db_comment='Field capacity (percentage)', blank=True, null=True)
    wilting_p = models.FloatField( db_comment='Wilting point (percentage)', blank=True, null=True)
    awc = models.FloatField( db_comment='Wilting point (percentage)', blank=True, null=True)
    ...
    acidity = models.FloatField( db_comment='Soil acidity: Exchangeable Al (meq/100g)', blank=True, null=True)
    met_acidity = models.TextField(db_comment='Method used for Soil acidity: Exchangeable Al (meq/100g)', blank=True, null=True)
    ph_h2o = models.FloatField( db_comment='pH (H2O)', blank=True, null=True)
    ...
    ph_kcl = models.FloatField( db_comment='pH (KCl)', blank=True, null=True)
    ...
    ph_ccl = models.FloatField( db_comment='pH (CaCl2)', blank=True, null=True)
    ...
    org_car = models.FloatField( db_comment='Organic Carbon content (g/kg)', blank=True, null=True)
    ...
    cec = models.FloatField( db_comment='CEC (cmol/Kg)', blank=True, null=True)
    ...
    ca = models.FloatField( db_comment='Ca++ (cmol/Kg)', blank=True, null=True)
    mg = models.FloatField( db_comment='Mg++ (cmol/Kg)', blank=True, null=True)
    na = models.FloatField( db_comment='Na+ (cmol/Kg)', blank=True, null=True)
    k = models.FloatField( db_comment='K+ (cmol/Kg)', blank=True, null=True)
    ...
    base_saturation = models.FloatField( db_comment='base saturation', blank=True, null=True)          
    esp = models.FloatField( db_comment='ESP (ratio)', blank=True, null=True)  
    sol_ca = models.FloatField( db_comment='Sol. Ca++ (cmol/L)', blank=True, null=True)
    sol_mg = models.FloatField( db_comment='Sol. Mg++ (cmol/L)', blank=True, null=True)
    sol_na = models.FloatField( db_comment='Sol. Na++ (cmol/L)', blank=True, null=True)
    ...
    sar = models.FloatField( db_comment='SAR (ratio)', blank=True, null=True)
    n_tot = models.FloatField( db_comment='N tot content (g/Kg)', blank=True, null=True)
    ...
    p_cont = models.FloatField( db_comment='Available P content(mg/kg)', blank=True, null=True)
    ...
    feox = models.FloatField( db_comment='Feox (g/kg)', blank=True, null=True)
    fed = models.FloatField( db_comment='Fed (g/kg)', blank=True, null=True)
    fep = models.FloatField( db_comment='Fep (g/kg)', blank=True, null=True)
    fe_tot = models.FloatField( db_comment='Fe tot (g/kg)', blank=True, null=True)
    ...
    mn = models.FloatField( db_comment='Mn (mg/kg)', blank=True, null=True)
    ...
    zn = models.FloatField( db_comment='Zn (mg/kg)', blank=True, null=True)
    ...
    cu = models.FloatField( db_comment='Cu (mg/kg)', blank=True, null=True)
...
class LayerRemnants(models.Model):
    id = models.TextField(primary_key=True, db_comment='identifier')
    abundance = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    ...
    abundance1 = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    abundance2 = models.FloatField( validators=[validate_percentage], blank=True, null=True)
...
class LayerCoarseFragments(models.Model):
    ...
    abundance1 = models.FloatField( blank=True, null=True, validators=[validate_percentage], db_comment='Report the total percentage of the volume occupied by coarse fragments for class1.')
    abundance2 = models.FloatField( blank=True, null=True, validators=[validate_percentage], db_comment='Report the total percentage of the volume occupied by coarse fragments for class2.')
    abundance3 = models.FloatField( blank=True, null=True, validators=[validate_percentage], db_comment='Report the total percentage of the volume occupied by coarse fragments for class3.')
    abundance4 = models.FloatField( blank=True, null=True, validators=[validate_percentage], db_comment='Report the total percentage of the volume occupied by coarse fragments for class4.')
...
class LayerArtefacts(models.Model):
    id = models.TextField(primary_key=True, db_comment='identifier')
    abundance = models.FloatField( blank=True, null=True, validators=[validate_percentage])
    black_carb = models.FloatField( blank=True, null=True, validators=[validate_percentage])
    ...
    abundance1 = models.FloatField( blank=True, null=True, validators=[validate_percentage])
    abundance2 = models.FloatField( blank=True, null=True, validators=[validate_percentage])
    abundance3 = models.FloatField( blank=True, null=True, validators=[validate_percentage])
    abundance4 = models.FloatField( blank=True, null=True, validators=[validate_percentage])
    abundance5 = models.FloatField( blank=True, null=True, validators=[validate_percentage])
...
class LayerCracks(models.Model):
    ...
    avg_width = models.FloatField( validators=[validate_positive], blank=True, null=True)
...
class LayerMatrixColours(models.Model):
    ...
    area1 = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    munsell_m2 = models.TextField(blank=True, null=True)
    munsell_d2 = models.TextField(blank=True, null=True)
    area2 = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    munsell_m3 = models.TextField(blank=True, null=True)
    munsell_d3 = models.TextField(blank=True, null=True)
    area3 = models.FloatField( validators=[validate_percentage], blank=True, null=True)
...
class LayerRedoximorphic(models.Model):
    ...
    oxi_outer = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    oxi_random = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    red_inner = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    red_outer = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    red_random = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    abund_oxi = models.FloatField( validators=[validate_percentage], db_comment='Abundance of cemented oximorphic features, by volume [%]', blank=True, null=True)
    ...
    clr1_area = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    ...
    clr2_area = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    ...
    clr3_area = models.FloatField( validators=[validate_percentage], blank=True, null=True)
...
class LayerCoatingsBridges(models.Model):
    ...
    crack_coat = models.FloatField( validators=[validate_percentage], blank=True, null=True, db_comment='Abundance of cracked coatings in percentage')
    clay_bridg = models.FloatField( validators=[validate_percentage], blank=True, null=True, db_comment='Abundance of clay bridges in percentage')
    ...
    sand_silt = models.FloatField( validators=[validate_percentage], blank=True, null=True, db_comment='Abundance of uncoated sand and coarse silt grains in percentage')
...
class LayerCarbonates(models.Model):
    ...
    sec_abund1 = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    sec_abund2 = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    sec_abund3 = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    sec_abund4 = models.FloatField( validators=[validate_percentage], blank=True, null=True)
...
class LayerGypsum(models.Model):
    ...
    sec_gypsum = models.FloatField( validators=[validate_percentage], blank=True, null=True)
...
class LayerSecondarySilica(models.Model):
    ...
    abund = models.FloatField( validators=[validate_percentage], blank=True, null=True, db_comment='Report the total percentage (by exposed area) of secondary silica')
    abund_dnfc = models.FloatField( validators=[validate_percentage], blank=True, null=True, db_comment='If a layer shows durinodes and/or remnants of a cemented layer, report in addition the percentage (by volume) of those durinodes and remnants that have a diameter ≥ 1 cm')
...
class LayerConsistence(models.Model):
    ...
    penet_res = models.FloatField( blank=True, null=True)
...
class LayerPermafrost(models.Model):
    ...
    cry_abund1 = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    cry_abund2 = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    cry_abund3 = models.FloatField( validators=[validate_percentage], blank=True, null=True)
...
class LayerOrganicCarbon(models.Model):
    ...
    contentmax = models.FloatField( blank=True, null=True)
    ...
    abundance1 = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    abundance2 = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    abundance3 = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    black_carb = models.FloatField( validators=[validate_percentage], blank=True, null=True)
...
class LayerAnimalActivity(models.Model):
    ...
    mammal = models.FloatField( blank=True, null=True, validators=[validate_percentage])
    bird = models.FloatField( blank=True, null=True, validators=[validate_percentage])
    worm = models.FloatField( blank=True, null=True, validators=[validate_percentage])
    insect = models.FloatField( blank=True, null=True, validators=[validate_percentage])
    unspecify = models.FloatField( blank=True, null=True, validators=[validate_percentage])
...
class LayerDegreeDecomposition(models.Model):
    id = models.TextField(primary_key=True, db_comment='identifier')
    vis_plant = models.FloatField( blank=True, null=True, validators=[validate_percentage])
...
class PointLayer(models.Model):
    ...
    upper = models.FloatField( validators=[validate_positive], db_comment='upper depth in cm',blank=True, null=True)
    lower = models.FloatField( validators=[validate_positive], db_comment='lower depth in cm',blank=True, null=True)
    lower_bound = models.TextField(db_comment='layer lower boundary ', blank=True, null=True )
    hom_part = models.FloatField( validators=[validate_percentage], blank=True, null=True, db_comment='Described parts, by exposed area [%]')
    ...
    struct_w_s = models.FloatField( validators=[validate_percentage], blank=True, null=True, db_comment='Structure Wedge-shaped aggregates tilted between ≥ 10° and ≤ 60° from the horizontal: abundance, by volume [%]')
    ...
    weathering = models.FloatField( validators=[validate_percentage], blank=True, null=True, db_comment='Initial weathering abundance')
    sol_salts = models.FloatField( validators=[validate_percentage], blank=True, null=True, db_comment='ECSE [dS m-1m-1]')
    saline_eff_cont = models.FloatField( blank=True, null=True, db_comment='Saline efflorescence Continuity')
    ph_value = models.FloatField( blank=True, null=True, db_comment='Potentiometric pH measurement - Measured value')
    ...
    fracts = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    avg_fracts = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    ...
    bulk_dens = models.FloatField( blank=True, null=True)
    ...
    coars_text = models.FloatField( validators=[validate_percentage], blank=True, null=True, db_comment='the percentage (by exposed area) occupied by coarser-textured parts of any orientation (vertical, horizontal, inclined) having a width of ≥ 0.5 cm')
    coars_text_v_tongues = models.FloatField( validators=[validate_percentage], blank=True, null=True, db_comment='the percentage (by exposed area) occupied by continuous vertical tongues of coarser-textured parts with a horizontal extension of ≥ 1 cm (if these tongues are absent, report 0%)')
    coars_text_depth = models.FloatField( validators=[validate_percentage], blank=True, null=True, db_comment='the depth range in cm, where these tongues cover ≥ 10% of the exposed area (if they extend across several layers, the length is only reported in the description of that layer, where they start at the layer’s upper limit).')
    coars_text_h_area = models.FloatField( validators=[validate_percentage], blank=True, null=True, db_comment='In the middle of the layer, prepare a horizontal surface, 50 cm x 50 cm, and report the percentage (by horizontal area covered) of the coarser-textured parts.')
    stress_fts_pressfaces = models.FloatField( validators=[validate_percentage], blank=True, null=True, db_comment='Pressure faces in % of the surfaces of soil aggregates')
    stress_fts_slicksides = models.FloatField( validators=[validate_percentage], blank=True, null=True, db_comment='Slickensides in % of the surfaces of soil aggregates.')
    ...
    ribbonl_acc_comb_thick = models.FloatField( validators=[validate_positive], blank=True, null=True, db_comment='If there are 2 or more ribbon-like accumulations in one layer, report the number of the accumulations and their combined thickness in cm')
    ...
    sur_crusts_avg_thickn = models.FloatField( validators=[validate_percentage], blank=True, null=True)
...
class LayerStructure(models.Model):
    ...
    abundance_vol = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    abundance1 = models.FloatField( validators=[validate_percentage], blank=True, null=True)
    abundance2 = models.FloatField( validators=[validate_percentage], blank=True, null=True)
