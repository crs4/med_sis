...
# ##########################################################
# Run a backup
#  SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./s4m_catalogue/br/backup.sh $BKP_FOLDER_NAME
#   - BKP_FOLDER_NAME:
...
#
# e.g.:
#  docker exec -it django4s4m_catalogue sh -c 'SOURCE_URL=$SOURCE_URL TARGET_URL=$TARGET_URL ./s4m_catalogue/br/backup.sh $BKP_FOLDER_NAME'
# ##########################################################
...
echo "-----------------------------------------------------"
echo "STARTING s4m_catalogue BACKUP $(date)"
echo "-----------------------------------------------------"
...
./manage.sh backup -i -f -c $PWD/s4m_catalogue/br/settings_docker.ini --backup-dir /$BKP_FOLDER_NAME/
