...
try:
    from my_geo.local_settings import *
...
SITENAME = os.getenv("SITENAME", "my_geo")
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('GEONODE_DATABASE', 'my_geo'),
        'USER': os.getenv('GEONODE_DATABASE_USER', 'my_geo'),
        'PASSWORD': os.getenv('GEONODE_DATABASE_PASSWORD', 'geonode'),
        'HOST': os.getenv('DATABASE_HOST', 'db'),
        'PORT': os.getenv('DATABASE_PORT', '5432'),
        'CONN_MAX_AGE': int(os.getenv('GEONODE_DB_CONN_MAX_AGE', 0)),
        'CONN_TOUT': int(os.getenv('GEONODE_DB_CONN_TOUT', 5)),
        'OPTIONS': {
            'connect_timeout': int(os.getenv('GEONODE_DB_CONN_TOUT', 5)),
        }
    },
    'soildata': {
        'ENGINE': 'django.contrib.gis.db.backends.postgis',
        'NAME': os.getenv('SOILDATA_DATABASE', 'soildata_db'),
        'USER': os.getenv('SOILDATA_DATABASE_USER', 'soildata_user'),
        'PASSWORD': os.getenv('SOILDATA_DATABASE_PASSWORD', 'soildata_pwd'),
        'HOST': os.getenv('DATABASE_HOST', 'db'),
        'PORT': os.getenv('DATABASE_PORT', '5432'),
    }
}
...
DATABASE_ROUTERS = ['my_geo.database_router.BackofficeRouter']